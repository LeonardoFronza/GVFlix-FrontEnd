import { TextField as MaterialTextField, Skeleton, TextFieldProps } from "@mui/material";
...
export const TextField: React.FC<ITogetherTextFieldProps> = ({ 
    ...
    return (
        <MaterialTextField {...rest} value={value} fullWidth error={!!error} helperText={error} variant="outlined" onChange={(e) => handleChange(e, e.target.value)}/>
    );
};
